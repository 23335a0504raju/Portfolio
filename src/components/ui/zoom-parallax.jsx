...
export function ZoomParallax({ images }) {
    ...
    // Apply a smooth spring physics layer to fix the "sticky/janky" raw mouse wheel scroll
            ...
            <div className="sticky top-0 h-screen overflow-hidden">
                {images.map(({ src, alt }, index) => {
                    ...
                    return (
                        ...
                        >
                            <div className="relative h-[25vh] w-[25vw] overflow-hidden rounded-2xl shadow-2xl border border-white/10 group">
                                <img
