...
export const LayoutGrid = ({ cards }) => {
    ...
    return (
        <div className="w-full h-full p-2 md:p-8 grid grid-cols-1 md:grid-cols-3 auto-rows-[280px] md:auto-rows-[320px] lg:auto-rows-[360px] max-w-screen-2xl mx-auto gap-6 relative">
            {cards.map((card, i) => (
